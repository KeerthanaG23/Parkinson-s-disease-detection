...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.BrowseImage.setStyleSheet("background-color: gray")
        self.imageLbl = QtWidgets.QLabel(self.centralwidget)
        self.imageLbl.setGeometry(QtCore.QRect(200, 80, 361, 261))
        self.imageLbl.setFrameShape(QtWidgets.QFrame.Box)
        self.imageLbl.setText("")
        self.imageLbl.setObjectName("imageLbl")
        self.imageLbl.setStyleSheet("background-color: gray")
        ...
        self.Classify.setStyleSheet("background-color: gray")
    ...
    def loadImage(self):
        fileName, _ = QtWidgets.QFileDialog.getOpenFileName(None, "Select Image", "D:/NIT Trichy/PD_detection/wave/testing", "Image Files (*.png *.jpg *jpeg *.bmp);;All Files ()")# Ask for file
